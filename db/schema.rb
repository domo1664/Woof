...
ActiveRecord::Schema.define(version: 20170119160547) do
  ...
  create_table "followers", force: :cascade do |t|
    ...
    t.index ["follower_id", "followed_id"], name: "index_followers_on_follower_id_and_followed_id", unique: true, using: :btree
